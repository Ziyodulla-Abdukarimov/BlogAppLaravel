<x-admin-layout>
    ...
    <div class="grid md:grid-cols-3 gap-6">
        ...
        <!-- Stats: Posts -->
        <x-admin.stats-card title="Postlar" :count="$postsCount" :link="route('posts.index')">
            <x-slot name="icon">
            ...
            <div class="px-6 py-4 flex items-center">
                ...
                <h3 class="ml-2 text-gray-600 font-medium">Eng sara postlar</h3>
            </div>
        ...
        <!-- Stats: Comments -->
        <x-admin.stats-card title="Sharhlar" :count="$commentsCount" :link="route('comments.index')">
            <x-slot name="icon">
                <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="px-6 py-4 flex items-center">
                ...
                <h3 class="ml-2 text-gray-600 font-medium">Oxirgi sharhlar</h3>
            </div>
        ...
        <!-- Stats: Users -->
        <x-admin.stats-card title="Foydalanuvchilar" :count="$usersCount" :link="route('users.index')">
            <x-slot name="icon">
                <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="px-6 py-4 flex items-center">
                ...
                <h3 class="ml-2 text-gray-600 font-medium">Yangi foydalanuvchilar</h3>
            </div>
